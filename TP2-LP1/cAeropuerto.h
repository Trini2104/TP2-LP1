...
public:
	cAeropuerto(const string ID, const int _CapacidadDeAeropuerto);
	~cAeropuerto();

	bool DarPermiso(); // da o no da el permiso segun la disponibilidad del hangar; 
	void CantidadTotalDePasajerosXDia(); //tiene que resivir la cantidad actual de paajeros de cada avion de la lista ade aviones
